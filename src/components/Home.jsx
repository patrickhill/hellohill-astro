              ...
              <a href="/casestudies/lookbuilder" className={`hover-3d block !overflow-visible rounded-[1.05rem] bg-gray-800 p-16 transition duration-300   hover:bg-gray-700 sm:rounded-[1.85rem] sm:p-24`}>
                ...
                <div className="mt-32 flex justify-between space-x-8">
                  <div>
                    ...
                    <p className="text-base font-light text-white">Visualizing custom suit combinations</p>
                  </div>
                  <Button>Read</Button>
                </div>
              </a>
              ...
              <div className={`block !overflow-visible rounded-[1.05rem] bg-gray-800 p-16 hover:cursor-auto sm:rounded-[1.85rem] sm:p-24`}>
                ...
                <div className="mt-32 flex justify-between space-x-8">
                  <div>
                    ...
                    <p className="text-base font-light text-white">A simple meditation timer</p>
                  </div>
                  <div className={`${roundedClassNames} flex items-center justify-center bg-gray-700 px-16 font-extralight text-gray-200 sm:px-32 `}>Coming Soon</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="container">
        ...
        <div className="grid-misc grid grid-cols-1 place-items-center gap-64 md:grid-cols-2">
          {LatestWork.map((item, key) => (
            <div className={`webkit-corner-fix overflow-hidden ${roundedClassNames}`} key={key}>
              {item.heroType === "video" ? (
                <video
                  autoPlay
                  loop
          ...
          <Button href="https://dribbble.com/patrickhill" className="flex flex-col !px-32 !py-64">
            <svg className="mb-8 h-24 w-24" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" width="128" height="128" viewBox="0 0 128 128">
